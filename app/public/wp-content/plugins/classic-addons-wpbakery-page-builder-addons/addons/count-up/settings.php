...
$params = array(
	...
	array(
		"type"        => "textfield",
		"heading"     => __( 'Prefix', 'classic-addons' ),
		"param_name"  => "prefix",
		"description" => __( 'Text shown before the number, e.g. $ or +.', 'classic-addons' ),
		"group"       => 'General',
		"edit_field_class" => "vc_col-xs-6 vc_column",
	),
	array(
		"type"        => "textfield",
		"heading"     => __( 'Suffix', 'classic-addons' ),
		"param_name"  => "suffix",
		"description" => __( 'Text shown after the number, e.g. + or K.', 'classic-addons' ),
		"group"       => 'General',
		"edit_field_class" => "vc_col-xs-6 vc_column",
	),
	array(
		"type"        => "textfield",
		"heading"     => __( 'Thousands Separator', 'classic-addons' ),
		"param_name"  => "separator",
		"description" => __( 'Character to group thousands (e.g. , or .). Leave blank for none.', 'classic-addons' ),
		"group"       => 'General',
	),
	array(
		"type"       => "vc_link",
		...
		"description" => __( 'Optional — wraps the counter in a link.', 'classic-addons' ),
		"group"      => 'General',
	),
);